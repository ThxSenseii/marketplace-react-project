...
function Cart({ cart, onClearCart }) {
  const totalItems = cart ? cart.length : 0; // Verificación de nulidad para cart
  const totalPrice = cart ? cart.reduce((total, producto) => total + producto.price, 0) : 0; // Verificación de nulidad para cart
